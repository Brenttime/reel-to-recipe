...
function renderGrid(recipes) {
    ...
    recipeGrid.innerHTML = recipes.map((r, i) => `
        <article class="recipe-card" data-id="${r.id}" style="animation-delay: ${i * 0.05}s">
            ...
            <h3 class="card-title">${escapeHtml(r.title)}${isDrinkRecipe(r) ? ` <span class="drink-badge">${getDrinkEmoji(r)}</span>` : ''}${r.rating_avg >= 4 ? ' <span class="top-rated-badge" title="Top Rated"><svg viewBox="0 0 20 20" fill="currentColor" width="16" height="16"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/></svg></span>' : ''}</h3>
